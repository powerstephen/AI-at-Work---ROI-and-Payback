...
export const calcMarketing = (g: GlobalInputs, b: MarketingBaseline, u: UpliftMarketing): Results => {
const team = g.teamSize;
const adoption = g.adoptionRatePct/100;
...
const vendorSavings = b.assetsPerPersonMonth * team * b.vendorCostPerAsset * (u.outsourcingReductionPct/100);
...
const timeSavingsValue = timeSaved * g.hourlyCost;
const errorSavings = b.reportsPerPersonMonth * team * b.errorCostPerReport * (u.errorReductionPct/100);
